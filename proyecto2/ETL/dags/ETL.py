...
with DAG(
    ...
    # task: 2.9 poblar tabla municipio
    ...
    with TaskGroup('poblar_tablas') as poblar_tablas_dimensiones:
        ...
        poblar_customer = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_fact_CoberturaAcueducto_vivienda(csv_path ="dimension_vivienda")
        )
        ...
        poblar_date = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_conflicto(csv_path = "dimension_conflicto")
        )
        ...
        poblar_employee = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_demografia(csv_path = "dimension_demografia")
        )
        ...
        poblar_stock_item = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_desempleo(csv_path = "dimension_desempleo")
        )
        ...
        poblar_stock_item = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_fact_educacion(csv_path = "dimension_educacion")
        )
        ...
        poblar_stock_item = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_fact_salud(csv_path = "dimension_salud")
        )
        ...
        poblar_stock_item = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_fact_pobreza(csv_path = "dimension_pobreza")
        )
    ...
    poblar_fact_order = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_mineria(csv_path = "hecho_mineria")
    )

    # flujo de ejecución de las tareas  
    preprocesamiento >> crear_tablas_db >> poblar_municipio >> poblar_tablas_dimensiones >> poblar_fact_order
